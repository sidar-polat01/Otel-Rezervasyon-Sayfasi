...
<head>
    ...
    <title>@yield('title','Otel Başlık')</title>
    <style>
        ...
        *::after {
        ...
        header.masthead {
            ...
            background: linear-gradient(to bottom, rgba(92, 77, 66, 0.5) 0%, rgba(92, 77, 66, 0.5) 100%), url("https://images5.alphacoders.com/361/thumb-1920-361643.jpg");
        ...
        header.mastheada {
            padding-top: 10rem;
            padding-bottom: calc(10rem - 4.5rem);
            background: linear-gradient(to bottom, rgba(92, 77, 66, 0.6) 0%, rgba(92, 77, 66, 0.8) 100%), url("https://images5.alphacoders.com/361/thumb-1920-361643.jpg");
            background-position: center;
            background-repeat: no-repeat;
            background-attachment: scroll;
            background-size: cover;
