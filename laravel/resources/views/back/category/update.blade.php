        ...
        <div class="col-md-5 set">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{route('category.edit.post',$category->id)}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <img src="{{asset($category->image)}}" class="img-thumbnail rounded" width="200">
                            <input multiple type="file" name="image" class="form-control">
                        </div>
                        <div class="form-group ml-2">
                            <label>Oda Açıklaması</label>
                            <textarea name="description" class="form-control" cols="30" rows="4">{!! $category->description !!}</textarea>
                        </div>
